...
/// ```dart
/// // Cancel all requests
/// cancellationInterceptor.cancelAll();
/// 
/// // Tag a request for selective cancellation
/// dio.get('/endpoint', options: Options(extra: {'cancelTag': 'search'}));
/// cancellationInterceptor.cancelByTag('search');
/// ```
